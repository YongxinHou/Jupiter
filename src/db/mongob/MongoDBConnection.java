...
public class MongoDBConnection implements DBConnection{
	...
	public void setFavoriteItems(String userId, List<String> itemIds) {
		  ...
		  //eq 类似于 new Document
		  db.getCollection("users").updateOne(eq("user_id",userId), new Document("$push", new Document("favorite", new Document("$each", itemIds))));
	...
	public void unsetFavoriteItems(String userId, List<String> itemIds) {
		  ...
		  db.getCollection("users").updateOne(eq("user_id", userId), new Document("$pullAll", new Document("favorite", new Document("favorite", itemIds))));
